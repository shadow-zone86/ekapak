  ...
  return (
    <div className={cn('flex items-center gap-2', withBorder && 'rounded border border-stroke p-1')}>
            <button
              ...
              className="cursor-pointer w-7 h-7 rounded border border-stroke bg-white hover:bg-gray-50 hover:border-blue-600 flex items-center justify-center text-gray font-bold text-sm transition-smooth active:scale-95"
