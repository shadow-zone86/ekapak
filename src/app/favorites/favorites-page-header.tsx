...
export function FavoritesPageHeader() {
  ...
  const hasFavorites = favoriteUuids.length > 0;
  ...
  return (
    <>
      ...
      <div className="favorites-page-header mb-6 grid grid-cols-1 items-center gap-4 md:grid-cols-[auto_1fr_auto]">
        <Link
          href="/"
        ...
        <H1 className="favorites-page-header__title text-center text-2xl font-bold">Избранное</H1>
